...
1. Create .planning/ISSUES.md if doesn't exist (use `.gsd-framework/templates/issues.md`)
...
See .gsd-framework/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Use .gsd-framework/templates/summary.md for structure.
...
For commit message conventions, see .gsd-framework/references/git-integration.md
</step>
