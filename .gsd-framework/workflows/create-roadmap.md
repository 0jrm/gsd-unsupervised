...
1. .gsd-framework/templates/roadmap.md
2. .gsd-framework/templates/state.md
...
```bash
ls ~/.cursor/skills/expertise/ 2>/dev/null
```
...
Use template from `.gsd-framework/templates/roadmap.md`.
...
Use template from `.gsd-framework/templates/state.md`.
