...
1. .gsd-framework/templates/phase-prompt.md
2. .gsd-framework/references/plan-format.md
3. .gsd-framework/references/scope-estimation.md
4. .gsd-framework/references/checkpoints.md
5. .gsd-framework/references/tdd.md
...
See `.gsd-framework/references/tdd.md` for TDD plan structure.
...
See .gsd-framework/references/checkpoints.md for checkpoint structure.
</step>
...
See .gsd-framework/references/scope-estimation.md for complete guidance.
</step>
...
Use template from `.gsd-framework/templates/phase-prompt.md`.
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `.gsd-framework/references/tdd.md` for TDD plan structure.
</task_quality>
