...
**Platform Support:**
- **Claude Code:** Uses Task tool to spawn background subagents with TaskOutput for monitoring
- **Cursor IDE:** Leverages Cursor's native Agent Skills and subagent system for parallel execution
- **OpenCode:** Uses Task tool similar to Claude Code
</purpose>
