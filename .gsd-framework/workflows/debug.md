...
<references>
@.gsd-framework/references/debugging/debugging-mindset.md
@.gsd-framework/references/debugging/hypothesis-testing.md
@.gsd-framework/references/debugging/investigation-techniques.md
@.gsd-framework/references/debugging/verification-patterns.md
@.gsd-framework/references/debugging/when-to-research.md
</references>
...
"Context filling up. Safe to start a new chat - run /gsd/debug to resume."
</step>
